...
file_handler = logging.FileHandler('itesm_mlops_project/api/main_api.log') # Indicamos el nombre del archivo
...
def predict(titanic_features: Titanic) -> JSONResponse:
    predictor = ModelPredictor("itesm_mlops_project/models/logistic_regression_output.pkl")
